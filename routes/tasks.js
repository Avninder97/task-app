...
const { createIfNotExistUsersTable, createIfNotExistTokensTable, createIfNotExistTasksTable } = require('../utils/dbHelper');
const { tokenValidator } = require('../middlewares/auth');

router.get('/tasks', tokenValidator, async (req, res) => {
    try {
...
router.post('/tasks', tokenValidator, async (req, res) => {
    try {
        await createIfNotExistTasksTable();
...
router.get('/tasks/:id', tokenValidator, async (req, res) => {
    try {
...
router.patch('/tasks/:id', tokenValidator, async (req, res) => {
    try {
...
router.delete('/tasks/:id', tokenValidator, async (req, res) => {
    try {
